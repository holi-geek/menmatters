...
const AboutSection = () => {
  return (
    <section id="about" className="gradient-section">
      <LampContainer className="min-h-[400px] md:min-h-[500px]">
        <motion.h2
          initial={{ opacity: 0.5, y: 100 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
          className="mt-8 bg-gradient-to-br from-white to-primary/70 py-4 bg-clip-text text-center font-heading text-4xl md:text-6xl font-bold tracking-tight text-transparent"
        >
